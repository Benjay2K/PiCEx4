...
//Euler’s problem 23: calculate the sum of all the positive integers that cannot be written as the sum of two abundant numbers.
...
int main(void){
    ...
    for (i = 1; i < upper_limit; i++){      //i cannot surpass upper limit
        if(is_abundant(i)){
            abundants_count++;
        }
    }
